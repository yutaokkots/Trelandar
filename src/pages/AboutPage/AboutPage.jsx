    ...
    <main>
      <div className="bg-[#FCDEBE]">
        ...
        <div>
          ...
          <div id="default-carousel" className="relative w-full justify-center h-96 w-72" data-carousel="slide">
          <div className="relative text-center h-56 overflow-hidden rounded-lg md:h-96">
